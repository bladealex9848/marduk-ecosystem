...
// Probar la API key con una solicitud de imagen
function testImageRequest(apiKey) {
    return new Promise((resolve, reject) => {
        const data = JSON.stringify({
...
async function runTest() {
    try {
        ...
        // Probar solicitud de imagen
        console.log('\n3. Probando solicitud de imagen...');
        await testImageRequest(env.OPENROUTER_API_KEY);
