...
const fetch = require('node-fetch'); // Nota: Necesitas instalar este paquete con npm install node-fetch
...
async function testOpenRouterWithFetch() {
    try {
        ...
        console.log('Usando API key:', env.OPENROUTER_API_KEY.substring(0, 10) + '...');
